...
(function(exports) {
  ...
  var filesToM3U = function (event) {
      ...
      throw new Error("Failed pattern match at DragAndDropToM3U line 62, column 3 - line 78, column 1: " + [ mfiles.constructor.name ]);
  };
  var dropHandler = function (textarea) {
      return function (e) {
          return function __do() {
              DOM_Event_Event.preventDefault(e)();
              return Data_Functor["void"](Control_Monad_Eff.functorEff)(Control_Monad_Aff.runAff(Control_Monad_Eff_Console.logShow(Control_Monad_Eff_Exception.showError))(function (str) {
                  return DOM_HTML_HTMLTextAreaElement.setValue(str)(textarea);
...
(function(exports) {
  ...
  var main = windowLoad(function __do() {
      ...
      var v1 = Data_Functor.map(Control_Monad_Eff.functorEff)(Data_Maybe.fromJust())(DOM_Node_NonElementParentNode.getElementById("dropzone")(DOM_Node_Types.documentToNonElementParentNode(v)))();
      var v2 = Data_Functor.map(Control_Monad_Eff.functorEff)(Data_Maybe.fromJust())(DOM_Node_NonElementParentNode.getElementById("m3u")(DOM_Node_Types.documentToNonElementParentNode(v)))();
      DOM_Event_EventTarget.addEventListener("drop")(DOM_Event_EventTarget.eventListener(DragAndDropToM3U.dropHandler(Unsafe_Coerce.unsafeCoerce(v2))))(false)(DOM_Node_Types.elementToEventTarget(v1))();
