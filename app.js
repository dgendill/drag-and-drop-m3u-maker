...
(function(exports) {
  ...
  var validateElementConfig = function (config) {
      return function (doc) {
          var validateElements = Data_Traversable.traverse(Data_Traversable.traversableArray)(Data_Validation_Semigroup.applicativeV(Data_Semigroup.semigroupArray))(function (v) {
              ...
              throw new Error("Failed pattern match at Main line 175, column 7 - line 177, column 37: " + [ v.value0.constructor.name ]);
          });
  ...
  var dropEvents = function (eventType) {
      return function (target) {
          return Control_Coroutine_Aff["produce'"](Control_Monad_Aff_Class.monadAffState(Control_Monad_Aff_Class.monadAffAff))(function (emit) {
              return DOM_Event_EventTarget.addEventListener(eventType)(DOM_Event_EventTarget.eventListener(function ($41) {
                  return emit(Data_Either.Left.create($41));
              }))(false)(target);
          });
      };
  };
          ...
          var consumer = Control_Monad_Rec_Class.forever(Control_Monad_Free_Trans.monadRecFreeT(Control_Coroutine.functorAwait)(Control_Monad_State_Trans.monadStateT(Control_Monad_Aff.monadAff)))(Control_Bind.bindFlipped(Control_Monad_Free_Trans.bindFreeT(Control_Coroutine.functorAwait)(Control_Monad_State_Trans.monadStateT(Control_Monad_Aff.monadAff)))(function ($42) {
              return Control_Monad_Trans_Class.lift(Control_Monad_Free_Trans.monadTransFreeT(Control_Coroutine.functorAwait))(Control_Monad_State_Trans.monadStateT(Control_Monad_Aff.monadAff))((function (event) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Control_Monad_Aff.monadAff))(Control_Monad_Eff_Class.liftEff(Control_Monad_State_Trans.monadEffState(Control_Monad_Aff.monadEffAff))(DOM_Event_Event.preventDefault(event)))(function () {
                      var files = DragAndDropToM3U.eventToFiles(Unsafe_Coerce.unsafeCoerce(event));
                      return ondrop(files);
                  });
              })($42));
  ...
  var defaultFunctionalityConfig = {
      processFiles: function (newFiles) {
          return Control_Bind.bind(Control_Monad_State_Trans.bindStateT(Control_Monad_Aff.monadAff))(Control_Monad_State_Class.get(Control_Monad_State_Trans.monadStateStateT(Control_Monad_Aff.monadAff)))(function (v) {
              ...
              return Control_Bind.bind(Control_Monad_State_Trans.bindStateT(Control_Monad_Aff.monadAff))(Control_Monad_Trans_Class.lift(Control_Monad_State_Trans.monadTransStateT)(Control_Monad_Aff.monadAff)(Control_Monad_Aff.attempt(DragAndDropToM3U.foldToM3U(allFiles))))(function (v1) {
                  ...
                  throw new Error("Failed pattern match at Main line 139, column 5 - line 144, column 48: " + [ v1.constructor.name ]);
              });
          });
      }
  };
